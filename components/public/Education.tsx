    ...
    <section id="education" className="section">
      <div className="container">
        <SectionHead
          ...
          lede="Formal or self-directed — whichever is true. Edit content/education.ts."
        />
        ...
        <div className="grid-2">
          {education.map((e, i) => (
            <Reveal key={i} className="card edu-card">
              ...
              <span className="field"><Ph value={e.degree}>{e.degree}</Ph> · <Ph value={e.field}>{e.field}</Ph></span>
